...
export function FeedbackPanel({
  ...
  return (
    <section
      className={`feedback-panel ${feedback === 'valid' || feedback === 'enrolled' ? 'feedback-success' : feedback === 'duplicate' || feedback === 'invalid' ? 'feedback-alert' : ''} rounded-[1.35rem] border p-5 transition-colors duration-300 sm:p-6 ${stateClass}`}
