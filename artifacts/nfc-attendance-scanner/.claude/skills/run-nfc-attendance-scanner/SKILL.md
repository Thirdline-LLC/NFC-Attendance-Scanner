...
| Roster `/roster` | `roster-page`, `header-roster`, `text-scans-paused`, `link-scanner-resume`, `link-scanner`, `link-dashboard`, `roster-manager`, `input-roster-search`, `button-roster-clear`, `text-roster-count`, `table-roster`, `row-person-<id>`, `text-card-tail-<id>`, `button-edit-person-<id>`, `row-editor-<id>`, `text-roster-loading`, `text-roster-load-error`, `button-roster-retry`, `text-roster-save-error` |
